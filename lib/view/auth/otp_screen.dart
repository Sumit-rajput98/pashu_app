...
class _OTPScreenState extends State<OTPScreen> with TickerProviderStateMixin {
  ...
  void _handleResendOTP(AppLocalizations localizations) async {
    ...
    try {
      // 🔁 Call your resend OTP logic here via ViewModel or service
      final viewModel = context.read<RequestOtpViewRegisterModel>();
      ...
      if (mounted) {
        ...
        _showCustomTopSnackbar(
          context: context,
          message: localizations.otpResentTo(widget.phoneNumber),
          isError: false,
        );
